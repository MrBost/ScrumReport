...
//            }
    ...
    public static CellStyle getRatio(XSSFWorkbook wb) {
    ...
    public static CellStyle getRatio_1dp(XSSFWorkbook wb) {
        DataFormat df = wb.createDataFormat();
        CellStyle style = wb.createCellStyle();
    ...
    public CellStyle getRatio_1dpAlternatingRowStyle(XSSFWorkbook wb) {
        DataFormat df = wb.createDataFormat();
        XSSFFont font = wb.createFont();
        font.setFontName("Calibri");
        font.setFontHeightInPoints((short) 8);
    ...
    public static CellStyle getDateFormat(XSSFWorkbook wb){
    ...
    public CellStyle getDateAlternatingRowStyle(XSSFWorkbook wb) {
        CreationHelper createHelper = wb.getCreationHelper();
        XSSFCellStyle style = wb.createCellStyle();
        style.setDataFormat(
                createHelper.createDataFormat().getFormat("dd-MMM-yy"));
    ...
    public CellStyle getRatioAlternatingRowStyle(XSSFWorkbook wb) {
        DataFormat df = wb.createDataFormat();
        XSSFFont font = wb.createFont();
        font.setFontName("Calibri");
        font.setFontHeightInPoints((short) 8);
